...
<body>
	...
	<form name="register" class="form-horizontal" action="register-sop-researcher-.php" method="post" onsubmit="return validateForm()">
		...
		<div class="row">
		  ...
		  <div class="two-thirds column">
			...
			<option value="" selected="selected"></option>
				<?php
					include("query.php");
					$query = mysqli_query($conn, "SELECT * FROM `rso-projects` ORDER BY `rso-projects`.project_title;");
